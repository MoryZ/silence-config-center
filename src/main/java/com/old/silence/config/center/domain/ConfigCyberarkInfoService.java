...
public class ConfigCyberarkInfoService {
    ...
    public ConfigCyberarkInfoVo findByRemoteRequest(ConfigCyberarkInfoRequest configCyberarkInfoRequest) {
        ...
        // 2.查找密码映射
        var password = findPassword(configCyberarkInfoRequest.getAppId(), configCyberarkInfoRequest.getObject());
     ...
     * 2. 查找密码映射
     */
    private String findPassword(String componentCode, String object) {
